...
def go(args):
    ...
    logger.info("Convert lastreview to datetime format")
    ...
    logger.info(f'Save cleaned dataset to Weights & Biases {args.output_artifact}')
